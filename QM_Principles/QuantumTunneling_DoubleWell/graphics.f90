...
!-----------------------------!
 ...
 write(1,*)'-200 0 moveto 400 0 rlineto 0 315 rlineto -400 0 rlineto'
 ...
 write(1,*) '-135 375 moveto'
 write(1,*) '(QUANTUM TUNNELING) show'
 write(1,*) '-110 350 moveto'
 write(1,*) '([Double Well Potential]) show'
 write(1,*)'75 320 moveto'
 write(1,10)t/fs2au
